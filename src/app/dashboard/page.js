...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[#EEF2FF] via-[#E9EAFB] to-[#E5E7F5]">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-[#0F172A]/40 backdrop-blur-sm flex justify-center items-center">
          ...
          <div className="bg-[#F8FAFC] w-[450px] p-6 rounded-3xl shadow-2xl border border-[#DCE3F1]">
